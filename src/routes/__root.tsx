...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "QUBIT — Interactive Quantum Learning & Simulation" },
      {
        name: "description",
        content:
          "Learn quantum computing with a guided module map and an interactive Qiskit / QpiAI circuit composer.",
      },
      { property: "og:title", content: "QUBIT — Interactive Quantum Learning & Simulation" },
      {
        property: "og:description",
        content:
          "Guided quantum curriculum plus an interactive circuit composer with live analytics.",
      },
